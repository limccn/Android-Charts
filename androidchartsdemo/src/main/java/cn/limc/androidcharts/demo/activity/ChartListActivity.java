...
public class ChartListActivity extends Activity {
    ...
    private String[] mListTitle = {"SampleDemo", "GridChart", "LineChart", "SlipLineChart", "SlipAreaChart",
    ...
    private String[] mListStr = {"sampleDemo", "cn.limc.androidcharts.view.GridChart",
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                switch (position) {
                    ...
                    intent.setClass(ChartListActivity.this,
                            SampleDemoActivity.class);
                    startActivity(intent);
                    break;
                    case 1:
                        intent.setClass(ChartListActivity.this,
                                GridChartActivity.class);
                        startActivity(intent);
                        break;
                    case 2:
                        intent.setClass(ChartListActivity.this,
                    ...
                    case 3:
                        intent.setClass(ChartListActivity.this,
                                SlipLineChartActivity.class);
                        startActivity(intent);
                        break;
                    case 4:
                        intent.setClass(ChartListActivity.this,
                                SlipAreaChartActivity.class);
                        startActivity(intent);
                        break;
                    case 5:
                        intent.setClass(ChartListActivity.this,
                                SlipBandAreaChartActivity.class);
                        startActivity(intent);
                        break;
                    case 6:
                        intent.setClass(ChartListActivity.this,
                                StickChartActivity.class);
                        startActivity(intent);
                        break;
                    case 7:
                        intent.setClass(ChartListActivity.this,
                                SlipStickChartActivity.class);
                        startActivity(intent);
                        break;
                    case 8:
                        intent.setClass(ChartListActivity.this,
                                ColoredSlipStickChartActivity.class);
                        startActivity(intent);
                        break;
                    case 9:
                        intent.setClass(ChartListActivity.this,
                                MAStickChartActivity.class);
                        startActivity(intent);
                        break;
                    case 10:
                        intent.setClass(ChartListActivity.this,
                                MASlipStickChartActivity.class);
                        startActivity(intent);
                        break;
                    case 11:
                        intent.setClass(ChartListActivity.this,
                                MinusStickChartActivity.class);
                        startActivity(intent);
                        break;
                    case 12:
                        intent.setClass(ChartListActivity.this,
                                SlipMinusStickChartActivity.class);
                        startActivity(intent);
                        break;
                    case 13:
                        intent.setClass(ChartListActivity.this,
                    ...
                    case 14:
                        intent.setClass(ChartListActivity.this,
                                SlipCandleStickChartActivity.class);
                        startActivity(intent);
                        break;
                    case 15:
                        intent.setClass(ChartListActivity.this,
                                MACandleStickChartActivity.class);
                        startActivity(intent);
                        break;
                    case 16:
                        intent.setClass(ChartListActivity.this,
                                MASlipCandleStickChartActivity.class);
                        startActivity(intent);
                        break;
                    case 17:
                        intent.setClass(ChartListActivity.this,
                                BOLLMASlipCandleStickChartActivity.class);
                        startActivity(intent);
                        break;
                    case 18:
                        intent.setClass(ChartListActivity.this,
                                MACDChartActivity.class);
                        startActivity(intent);
                        break;
                    case 19:
                        intent.setClass(ChartListActivity.this,
                    ...
                    case 20:
                        intent.setClass(ChartListActivity.this,
                                RoseChartActivity.class);
                        startActivity(intent);
                        break;
                    case 21:
                        intent.setClass(ChartListActivity.this,
                                SpiderWebChartActivity.class);
                        startActivity(intent);
                        break;
                    case 22:
                        intent.setClass(ChartListActivity.this,
                                RadarChartActivity.class);
                        startActivity(intent);
                        break;
                    case 23:
                        intent.setClass(ChartListActivity.this,
                                DonutChartActivity.class);
                        startActivity(intent);
                        break;
                    case 24:
                        intent.setClass(ChartListActivity.this,
