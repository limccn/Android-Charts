...
import cn.limc.demo.common.utils.DateTimeUtils;
...
//      mBollmaslipcandlestickchart.setAxisXTitleQuadrantHeight(20);
	...
	private void initTickChartLines(){
		...
		List<DateValueEntity> arrMinsLineDatas = new ArrayList<>();
		...
		LineEntity<DateValueEntity> line = new LineEntity<>();
		line.setTitle("line");
...
//        mBOLLchart.setZoomBaseLine(IZoomable.ZOOM_BASE_LINE_CENTER);
	...
	private void replaceTickValue(List<OHLCVData> ohlcvDatas){
		...
		Map<String, OHLCVData> mapOhlcvDatas = new HashMap<>();
