...
//		CandleStickChart candlechart = (CandleStickChart) chart;
	 ...
	 *            </p>
	 */
	public void pushData(ColoredStickEntity entity) {
		if (null != entity) {
			addData(entity);
			super.postInvalidate();
		}
	 ...
	 *            </p>
	 */
	public void addData(ColoredStickEntity entity) {
		if (null != entity) {
			// data is null or empty
			if (null == stickData || 0 == stickData.size()) {
				stickData = new ArrayList<ColoredStickEntity>();
	 ...
	 */
	public void setStickData(List<ColoredStickEntity> stickData) {
