...
public class AndroidChartsActivity extends Activity {
	...
	List<ChartDataRow> ohlc;
	List<ChartDataRow> vol;
	List<ChartDataRow> volc;
	List<ChartDataRow> dv1;
	List<ChartDataRow> dv2;
	List<ChartDataRow> macd;
...
//
//		slipareachart.setChartData(lines);
//	}
//
...
//		// 为chart1增加均线
//		mastickchart.setStickData(new ListChartData<StickEntity>(vol));
//
//	}
//
...
//		// 为chart1增加均线
//		maslipstickchart.setStickData(new ListChartData<StickEntity>(vol));
//	}
//
...
//		minusstickchart.setStickData(new ListChartData<StickEntity>(data));
//
...
//
//		IChartData<StickEntity> datas = new ListChartData<StickEntity>(data);
...
//
//		// 为chart2增加均线
//		candlestickchart.setStickData(new ListChartData<StickEntity>(ohlc));
//	}
//
...
//				.setStickData(new ListChartData<StickEntity>(ohlc));
//	}
//
...
//
//		// 为chart2增加均线
//		macandlestickchart.setStickData(new ListChartData<StickEntity>(ohlc));
//
//	}
//
...
//
//		// 为chart2增加均线
//		maslipcandlestickchart.setStickData(new ListChartData<StickEntity>(
//				ohlc));
//
...
//
//		// 设置stickData
//		macdChart.setStickData(new ListChartData<StickEntity>(macd));
//	}
//
//	private void initVOLC() {
//		List<StickEntity> stick = new ArrayList<StickEntity>();
//		this.volc = new ArrayList<StickEntity>();
//
...
//	}
//
//	private List<ChartDataRow> initVMA(int days) {
//		if (days < 2) {
//			return null;
//		}
//
...
//		List<StickEntity> ohlc = new ArrayList<StickEntity>();
//
//		this.ohlc = new ArrayList<StickEntity>();
...
//	}
//
//	private List<ChartDataRow> initMA(int days) {
//
//		if (days < 2) {
//			return null;
//		}
