 ...
 *
 */
public class AreaChartController extends AbstractDiagramController{

    SimpleDataRange dataRange;
    SectionDataCursor dataCursor;
    SimpleGrid grid;
    DataComponent areaChartComponent;
    ...
    public void didApplyController() {
        ...
        componetController.setComponent(areaChartComponent);
