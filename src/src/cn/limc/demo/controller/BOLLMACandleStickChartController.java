/*
 * BOLLMACandleStickChartController.java
 * Android-Charts Demo
 *
...
/**
 * BOLLMACandleStickChartController
 * Description: <br>
...
public class BOLLMACandleStickChartController extends AbstractDiagramController {
    ...
    public BOLLMACandleStickChartController() {
        super();
        this.initController();
    }
    ...
    public void initComponentController() {
        componetController = new ComponentGroupHandler() {
            ...
            public ChartDataSet dataForComponent(DataComponent component) {
                if (component instanceof KChartComponent) {
                    return stickData;
                }else if (component instanceof LineChartComponent){
                    return lineData;
                }else {
                    return bandData;
                }
    ...
    public void didApplyController() {
        ...
        componetController.addComponent(bandChartComponent);
