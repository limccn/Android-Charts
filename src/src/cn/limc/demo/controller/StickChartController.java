 ...
 *
 */
public class StickChartController extends AbstractDiagramController {
    ...
    public void didApplyController() {
        ...
        componetController.setComponent(stickChartComponent);
